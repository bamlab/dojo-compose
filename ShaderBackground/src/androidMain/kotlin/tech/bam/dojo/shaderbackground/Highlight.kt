    ...
    Surface(
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            AnimatedVisibility(
                ...
                enter =
                    fadeIn(tween(delayMillis = 700, durationMillis = 400)) +
                        slideInHorizontally(
                            animationSpec = tween(delayMillis = 700, durationMillis = 400),
                            initialOffsetX = {
                                it / 3
                            },
                        ),
                exit =
                    fadeOut(tween(delayMillis = 0, durationMillis = 500)) +
                        shrinkOut(
                            tween(delayMillis = 0, durationMillis = 500),
                            clip = false,
                        ),
            ) {
                Box(
